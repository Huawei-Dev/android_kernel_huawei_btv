...
/*   41  */      en_NV_Item_DRV_CUSTOMIZE_TYPE = 41,        /*????NV??????????*/
...
/* Added by c00318887 for DPlmn??????????????HPLMN, 2015-5-18, begin */
...
/*  2337 */     en_NV_Item_Rnic_Netif_Rx_Type       = 2337,                     /* RNIC????????netif_rx?????????????? */
...
/* 2433 */      en_NV_Item_Emc_Under_Net_Pin_Cfg         = 2433,            /* ????????VDF???????????????????????????? */
...
/* 2470 */      en_NV_Item_Pdp_Redial_For_No_Pdp_Type_CAUSE_CFG     = 2470,     /* PDP??????????????????28???????????????????????? */
...
/* Added by w00146666 for H_PRIO??????2015-05-18, begin */
/* 3016 */      en_NV_Item_Inter_Rat_Resel_H_PRIO_Customization      = 3016,
/* Added by w00146666 for H_PRIO??????2015-05-18, end */
